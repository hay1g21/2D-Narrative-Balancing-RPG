...
public class EnemyTest { 
    ...
    [UnityTest]
    public IEnumerator BalanceChange()
    {
    ...
    [UnityTest]
    public IEnumerator BalanceChange2()
    {
        var gameObject = new GameObject();
        var enemy = gameObject.AddComponent<OverworldEnemy>();
        var box = gameObject.AddComponent<BoxCollider2D>();
        ...
        spawnPoint.spawnPointAccepts = enemy.balanceLevels = new List<int>() { 3, 4, 5, 6 };

        enemy.changeBalance(6);
        yield return new WaitForSeconds(2);
    ...
    [UnityTest]
    public IEnumerator BalanceChange3()
    {
        var gameObject = new GameObject();
        var enemy = gameObject.AddComponent<OverworldEnemy>();
        var box = gameObject.AddComponent<BoxCollider2D>();
        ...
        var spawns = new GameObject("Goblin2");
        ...
        enemy.changeBalance(5);
        yield return new WaitForSeconds(2);

        Assert.AreEqual(new Vector3(3, 3, 3), enemy.transform.position);
    }
}
